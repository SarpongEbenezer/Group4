...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO bookings (from_location, to_location, depart_date, return_date, adults, children, travel_class, email)
            VALUES ('$from', '$to', '$depart_date', '$return_date', '$adults', '$children', '$travel_class', '$email')";
           ...
           <!DOCTYPE html>
            <html lang="en">
                <head>
                    ...
                    <link rel="stylesheet" herf="http://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css">
                    <style>
                        *{
...
.signup-form{
    ...
    padding: 1.6rem;
            ...
            .signup-content2 .text-white{
                color: rgb(255, 255, 255);

            }

        .signup-content2 .Depart{
            width: 400px;
            padding: 10px;
            margin: 10px;
            color:rgb(0, 0, 0);
...
button[type=submit]:hover {
	background-color: rgb(39, 98, 146);
}
h1{
    color: #5b13b9;
}
    ...
    select{
        padding: 10px;
                ...
                <form>
                    ...
                    <div class="signup-form" style="background-color: #5b13b9">
                    
                    <div class="signup-head" style="background-color: #ffffff">
                    <h1> KYLE TRAVEL AND TOUR</h1>
                    ...
                    <label class="text-white travel"> Travel class</label><br>
                    ...
                    <select class="text-white " style="color: black;"><br>
                        ...
                        <br>
                    <input type="text" placeholder="E-mail" class="input bg-dark">
                    <br>
            <button type="submit"><a href="momopay.php">Pay With Mobile Money </a></button>
            <button type="submit"><a href="payment.php">Pay With Visa Card</a></button>
                </div>
